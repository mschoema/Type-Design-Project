...
parser.add_argument('--Edge_penalty', dest='Edge_penalty', type=int, default=100, help='weight for edge loss')
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        model = UNet(args.experiment_dir, batch_size=args.batch_size, experiment_id=args.experiment_id,
                     ...
                     Ltv_penalty=args.Ltv_penalty, Lcategory_penalty=args.Lcategory_penalty, Edge_penalty=args.Edge_penalty)
