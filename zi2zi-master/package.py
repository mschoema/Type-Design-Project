...
parser.add_argument('--dir', dest='dir', default="../outputFiles/Songti-for-training/train_256/", help='path of examples')
parser.add_argument('--save_dir', dest='save_dir', default="../outputFiles/experiment/data_songti/", help='path to save pickled files')
